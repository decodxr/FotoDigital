...
const navigation = [['dashboard', 'Visão geral', LayoutDashboard], ['orders', 'Pedidos', Package], ['products', 'Produtos', ShoppingBag], ['printSizes', 'Revelações', ImageIcon], ['users', 'Clientes', Users], ['categories', 'Categorias', Layers], ['coupons', 'Cupons', Tag], ['testimonials', 'Depoimentos', MessageSquare], ['services', 'Serviços fotográficos', Camera], ['inquiries', 'Solicitações', MessageSquare], ['banners', 'Vitrine animada', PanelTop], ['settings', 'Configurações', Settings], ['shipping', 'Frete', Truck], ['payments', 'Pagamentos', CreditCard], ['auditLogs', 'Registro de atividades', ShieldCheck]] as const;
const initialRecords: Record<string, Row> = { products: { name: '', slug: '', description: '', categoryId: 'personalizados', kind: 'product', image: '', images: [], price: null, salePrice: null, stock: null, active: 1, featured: 0, tags: [], fields: [], variants: [], productionDays: 0, weight: null, width: null, height: null, length: null }, categories: { name: '', slug: '', description: '', image: '', active: 1 }, printSizes: { name: '', width: 10, height: 15, price: null, active: 1, finishes: ['Brilhante', 'Fosco'], tiers: [] }, coupons: { code: '', type: 'percent', value: 0, minAmount: 0, expiresAt: null, categories: [], maxUses: null, perCustomer: 1, firstPurchase: 1, active: 0 }, testimonials: { name: '', rating: 5, comment: '', active: 0 }, services: { name: '', slug: '', description: '', image: '', gallery: [], faq: [], active: 1 }, banners: { title: '', subtitle: '', image: '', link: '/revelacao', active: 1, sortOrder: 1, illustrative: 0 } };
