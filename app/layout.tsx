...
}) { return <html lang="pt-BR"><head><link rel="preload" href="/fonts/dm-sans-latin.woff" as="font" type="font/woff" crossOrigin="anonymous"/></head><body className="antialiased"><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ ...localBusiness, url: origin() }).replace(/</g, '\\u003c') }}/>{children}</body></html>; }
